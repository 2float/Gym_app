      ...
      <div className="space-y-4">
        ...
        {history.length === 0 ? (
          ...
          history.slice(0, 5).map(log => {
            ...
            return (
              <div key={log.id || log.date} onClick={() => setSelectedWorkout(log)} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-500 group cursor-pointer">
